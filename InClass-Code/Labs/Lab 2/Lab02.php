...
<body>
    ...
    <hr />
    <form action="Lab02-Action.php" method="post">
        Name<font color=red>*</font>: <input type="text" name="name"> <br><br>
        E-mail<font color=red>*</font>: <input type="text" name="email"> <br><br>
